...
parseLine : String -> Result (List DeadEnd) PasswordEntry
parseLine string =
    Parser.run lineParser string


lineParser : Parser.Parser PasswordEntry
lineParser =
    Parser.succeed PasswordEntry
        |. spaces
        |= int
        |. symbol "-"
        |= int
...
parseChars : Parser.Parser String
parseChars =
    getChompedString <|
        Parser.succeed ()
