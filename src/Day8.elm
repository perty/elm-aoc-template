...
parse : String -> List Observation
parse string =
    case Parser.run (Parser.Extras.many observationParser) string of
        Ok value ->
            value
...
signalParser : Parser (List String)
signalParser =
    Parser.sequence
        { start = ""
        , end = "|"
...
digitsParser : Parser (List String)
digitsParser =
    Parser.sequence
        { start = ""
        , end = "\n"
